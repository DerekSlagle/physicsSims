...
//    static vec2d* pGravity;
    ...
    // static function
    static unsigned int hitAll( std::vector<mvHit*>& pmhVec );
    static void updateAll( std::vector<mvHit*>& pmhVec, float dt );
    static void updateAll( std::vector<mvHit*>& pmhVec, vec2d Grav, float dt );
    static void boundInWindow( mvHit& mh );
 ...
 //   const mvHit& operator=( const mvHit& rMH );
  ...
  //  virtual state_ab* newState();// over ride in expandPolygon
    ...
    virtual bool intersect( const mvHit& )const = 0;
    virtual bool intersect( const ball& )const = 0;
    virtual bool intersect( const regPolygon& )const = 0;
