...
bool regPolygon::intersect( const mvHit& mh )const { return mh.intersect( *static_cast<const regPolygon*>(this) ); }

bool regPolygon::intersect( const ball& rB )const
{
...
bool regPolygon::intersect( const regPolygon& py )const
{
    vec2d sep, N;
    float a;
