...
//    sf_contact* pContactSel = nullptr;
    ...
    sf_orGate orGate_toCopy;// now it is a terminal type
//    sf_orGate* pOrGateSel = nullptr;// for calling setPosition() in "move" mode
    ...
    sf_limitSwitch* pLSfirst = nullptr;// 1st LS selected during path definition in program mode using addToLoadPath( sf_limitSwitch& )
